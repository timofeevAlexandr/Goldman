 ...
 * @author Alex
 */
class FrameSavedGames extends BaseChildFrame {
    ...
    private void initComponents() {
        ...
        jbtnLoadGame.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/alex/gui/icons/loadSmall.png"))); // NOI18N
        jbtnLoadGame.setText("Загрузить");
        jbtnLoadGame.addActionListener(this::jbtnLoadGameActionPerformed);

        jbtnReturn.setText("<< в меню");
        jbtnReturn.setName("FrameStat"); // NOI18N
        jbtnReturn.addActionListener(this::jbtnReturnActionPerformed);

        jbtnDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/alex/gui/icons/delete.png"))); // NOI18N
